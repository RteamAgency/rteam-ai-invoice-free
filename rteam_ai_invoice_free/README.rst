...
AI-powered vendor invoice extraction from PDF and JPG files, directly inside Odoo 18.
...
Free tier: **5 extractions per company per month**. Upgrade to Rteam AI Invoice
Pro for unlimited use.

Features
--------

- **Extract from PDF/JPG** button on draft vendor bills (in_invoice / in_refund).
- AI returns vendor name, VAT, invoice number, invoice date, due date, currency,
  and line items (description, quantity, unit price, tax rate).
...
- Monthly quota (5/month) tracked per company; clear upgrade CTA at limit.
...
3. Open any draft vendor bill and click **Extract from PDF**.
